...
def load_yp_mapping_table(affiliate_name):
    ...
    file_path_map = {
        ...
        # 💡 以后如果接了新联盟（比如 CJ、Impact），只需要在这里加一行即可：
        # "CJ Affiliate": r"C:\Users\13264\Desktop\数据分析工具\YP-CJ.xlsx",
    }
